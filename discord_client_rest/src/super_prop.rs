...
pub fn build_super_props(build_num: u32) -> String {
    let props = SuperProps {
        ...
        browser_user_agent: "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/136.0.0.0 Safari/537.36".to_string(),
        browser_version: "136.0.0.0".to_string(),
